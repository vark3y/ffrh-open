...
STRONG_FUNDING_RX = re.compile(r"\bCSR\b|corporate social responsibility|\bgrant(s|ed)?\b|\bMoU\b|sanction(ed|s)?\b|\bcrore\b|\blakh\b|foundation|philanthrop", re.I)
THEME_RX = {
